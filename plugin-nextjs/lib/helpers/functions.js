...
exports.setupImageFunction =
  exports.generatePagesResolver =
  exports.generateFunctions =
    void 0;
...
const generateFunctions = async (
  {
    FUNCTIONS_SRC = constants_1.DEFAULT_FUNCTIONS_SRC,
  ...
  const functionDir = (0, pathe_1.join)(
    process.cwd(),
    functionsDir,
    constants_1.HANDLER_FUNCTION_NAME
  );
  const publishDir = (0, pathe_1.relative)(
    functionDir,
    (0, pathe_1.resolve)(PUBLISH_DIR)
  );
  const writeHandler = async (func, isODB) => {
    ...
    await (0, fs_extra_1.writeFile)(
      (0, pathe_1.join)(functionsDir, func, `${func}.js`),
      handlerSource
    );

    await (0, fs_extra_1.writeFile)(
      (0, pathe_1.join)(functionsDir, func, `package.json`),
      '{"type":"commonjs"}'
    );
    await (0, fs_extra_1.copyFile)(
      node_bridge_1.default,
      (0, pathe_1.join)(functionsDir, func, "bridge.js")
    );
    await (0, fs_extra_1.copyFile)(
      (0, pathe_1.join)(
        __dirname,
      ...
      (0, pathe_1.join)(functionsDir, func, "handlerUtils.js")
    );
  };
 ...
 */
const generatePagesResolver = async ({
  constants: {
    INTERNAL_FUNCTIONS_SRC,
    FUNCTIONS_SRC = constants_1.DEFAULT_FUNCTIONS_SRC,
    PUBLISH_DIR,
  ...
  await (0, fs_extra_1.writeFile)(
    (0, pathe_1.join)(functionsPath, constants_1.ODB_FUNCTION_NAME, "pages.js"),
    jsSource
  );
  await (0, fs_extra_1.writeFile)(
    (0, pathe_1.join)(
...
const setupImageFunction = async ({
  ...
  const functionDirectory = (0, pathe_1.join)(
    functionsPath,
    constants_1.IMAGE_FUNCTION_NAME
  );
  await (0, fs_extra_1.ensureDir)(functionDirectory);
  await (0, fs_extra_1.writeJSON)(
    (0, pathe_1.join)(functionDirectory, "imageconfig.json"),
    {
      ...imageconfig,
  ...
  await (0, fs_extra_1.copyFile)(
    (0, pathe_1.join)(__dirname, "..", "..", "lib", "templates", "ipx.js"),
    (0, pathe_1.join)(functionDirectory, functionName)
  );
